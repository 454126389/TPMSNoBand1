...
//	public static final int SOCKET_CLOSED = 2;
    ...
    public void registerSocket(BluetoothSocket socket, BluetoothConnModel.ConnectedThread t, int socketState){
    ...
    public BluetoothConnModel.ConnectedThread getConnectedThread(BluetoothSocket socket){
		BluetoothSocketInfo socketInfo = null;
		try {
			 socketInfo = mBluetoothSocekts.get(socket);
